...
class MainActivity : AppCompatActivity(), LeScanCallback.DeviceFound, ItemClickListener {
            ...
            when (selectedOption) {
                "Update" -> {
                    ...
                    dialogBuilder.setPositiveButton("Save") { dialog, whichButton ->
                        ...
                        DatabaseHelper(this).updateResponseData(responseAdapter.getString(itemId.toInt()).toString(),newRD)
                ...
                "Delete" -> {
                    ...
                    DatabaseHelper(this).deleteResponseData(responseAdapter.getString(itemId.toInt()).toString())
